...
conda install pytorch==1.13.1 torchvision==0.14.1 torchaudio==0.13.1 pytorch-cuda=11.6 -c pytorch -c nvidia --yes
...
conda install xformers==0.0.16 -c xformers --yes
